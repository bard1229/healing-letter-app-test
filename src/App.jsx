      ...
      const initialReports = [
        {
          ...
          generatedAt: new Date().toISOString(),
          content: {
            overview: '本月你記錄了 15 天的心情，從這一個月的紀錄看來，你似乎正處在一個相對平穩但也在思考人生方向的階段。整體來說，情緒起伏不算太劇烈，能夠察覺自己的感受並試著在忙碌中找到平衡。',
            suggestions: [
              '持續保持自我覺察的習慣，這會幫助你在壓力來臨時及時調整',
              '可以嘗試建立更固定的放鬆儀式，例如睡前的靜心時間',
              '在感到迷茫時，不妨寫下三個當下可以採取的小行動'
            ],
            highlights: {
            ...
            encouragement: '這個月的你展現了很好的情緒穩定度，即使偶爾感到迷茫或壓力，你都能夠好好地與自己對話。繼續保持這份對內在的關注，你正走在一條越來越了解自己的路上。'
          }
        },
        {
          id: 'month_2025_10',
          ...
          content: {
            overview: '十月份你記錄了 12 天，這個月的情緒波動較大，可能遇到了一些挑戰。',
            suggestions: [
              '注意休息和自我照顧',
              '適時尋求支持',
              '保持運動習慣'
            ...
            encouragement: '雖然這個月比較辛苦，但你一直在努力面對。記住，低谷也是成長的一部分。'
          }
        }
      ];
      
      setMonthlyReports(initialReports);
      alert('✅ 月報測試資料已建立！可以在首頁看到月報卡片');
    } else {
      alert('📊 測試資料已存在！請在首頁查看月報卡片');
    }
  };
// 解鎖月報 (目前只是測試，未接金流)
